...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        var z = t.style,
            ...
            q = {};
        C.transform && (Q.transform = [V], q = { x: [I, "translateX"], y: [I, "translateY"], rotate: [T], rotateX: [T], rotateY: [T], scale: [g], scaleX: [g], scaleY: [g], skew: [T], skewX: [T], skewY: [T] }), C.transform && C.backface && (q.z = [I, "translateZ"], q.rotateZ = [T], q.scaleZ = [g], q.perspective = [m]);
        var $ = /ms/,
            Z = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    function gt(t) {
        var e = t.store,
            ...
            _ = m.getRefType(o),
            g = X(o, E, n, c, m, f);
        e.dispatch((0, y.instanceAdded)((0, a.default)({ instanceId: l, elementId: h, origin: g, refType: _ }, r))), mt(document.body, "ix2-animation-started", l), s ? function(t, e) {
    ...
    function It(t, e) {
        ...
        if (B(w, O.mediaQueryKey) && (r || n || i)) {
            ...
            if (i) {
                if (h) {
                    var D = _t({ store: e, eventId: l, eventTarget: d, eventStateKey: p, actionListId: v, groupIndex: f + 1, verbose: _ });
...
}, function(t, e, n) { n(121), n(123), n(65), n(125), n(315), n(316), n(317), n(318), t.exports = n(323) }, function(t, e, n) {
    "use strict";
    var r = n(6);
    ...
    if (a) {
        var v = new p,
            ...
            E = v.has,
            _ = v.set;
        r = function(t, e) { return _.call(v, t, e), e }, i = function(t) { return h.call(v, t) || {} }, o = function(t) { return E.call(v, t) }
    } else {
        var g = l("state");
            ...
            case ut:
                return function(t) {
                    var e = t.element,
                        ...
                        a = i(e, o),
                        u = St.test(a) ? a : r[o],
                        c = function(t, e) { var n = t.exec(e); return n ? n[1] : "" }(Rt, u).split(B);
            ...
            case Y:
                return function(t, e, n, r, i) {
                    var o = At.map(function(t) {
                        ...
                        a = i.setStyle;
                    xt(t, g.TRANSFORM_PREFIXED, i), a(t, g.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === Z && void 0 !== d || s === J && void 0 !== d || s === tt && (void 0 !== f || void 0 !== l)) && a(t, g.TRANSFORM_STYLE_PREFIXED, R);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case Q:
                ...
                return function(t, e, n) {
                    ...
                    switch (e.actionTypeId) {
                        case ct:
                            ...
                            return void(i === x && g.IS_BROWSER_ENV ? r(t, V, g.FLEX_PREFIXED) : r(t, V, i))
                    }
                }(t, i, a);
            case q:
    ...
    function gt(t) {
        ...
        if (A === h.EventAppliesTo.PAGE) { var R = f(T); return R ? [R] : [] }
        var x, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || b] || {},
            ...
            P = o && l(_t(o.target));
        if (D ? (x = L.limitAffectedElements, N = P, C = l(L)) : N = C = l({ id: T, selector: b, selectorGuids: w }), o && S) { var M = a && (C || !0 === S) ? [a] : d(P); if (C) { if (S === X) return d(C).filter(function(t) { return M.some(function(e) { return _(t, e) }) }); if (S === F) return d(C).filter(function(t) { return M.some(function(e) { return _(e, t) }) }); if (S === G) return d(C).filter(function(t) { return M.some(function(e) { return y(e, t) }) }) } return M }
        return null == N || null == C ? [] : g.IS_BROWSER_ENV && u ? d(C).filter(function(t) { return u.contains(t) }) : x === F ? d(N, C) : x === k ? p(d(N)).filter(E(C)) : x === G ? v(d(N)).filter(E(C)) : d(C)
    }
    var yt = /px/,
    ...
    function Lt(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e, i = t.actionTypeId,
                o = t.config;
            e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : Dt({ effect: Pt, actionTypeId: i, elementApi: r }), gt({ config: o, event: n, elementApi: r }).forEach(e)
        })
    }
    var Dt = function(t) {
        var e = t.effect,
        ...
        T = function(t, e) {
            ...
            if (E && !_)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var j = (O - g) / m, F = E.config.easing, k = h(F, j, f), G = 0, X = a.length; G < X; G++) {
                        var V = a[G],
                            U = y(s, V, E.config),
    ...
    var c, s, f, l = u(n(27)),
        ...
        _t = (r = {}, (0, o.default)(r, R, vt()), (0, o.default)(r, x, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, D, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, { types: "ecommerce-cart-open", handler: et(Z, tt) }), (0, o.default)(r, V, { types: "ecommerce-cart-close", handler: et(Z, tt) }), (0, o.default)(r, m, {
            types: "click",
                ...
                switch (u) {
                    ...
                    default:
                        ...
                        var P = n.getBoundingClientRect(),
                            ...
                            F = P.width,
                            k = P.height;
                        if (!D && ! function(t, e) { return t.left > e.left && t.left < e.right && t.top > e.top && t.top < e.bottom }({ left: v, top: g }, P)) break;
                        S = !0, w = O ? (v - M) / F : (g - j) / k
                }
                return b && (w > .95 || w < .05) && (w = Math.round(w)), (u !== h.EventBasedOn.ELEMENT || S || S !== a.elementHovered) && (w = f ? 1 - w : w, e.dispatch((0, _.parameterChanged)(A, w))), { elementHovered: S, clientX: v, clientY: g, pageX: m, pageY: T }
            }
        }), (0, o.default)(r, B, {
            types: it,
            handler: function(t) {
            ...
            handler: function(t) {
                var e = t.element,
                    ...
                    b = void 0 === O ? 0 : O,
                    w = "X_AXIS" === p;
                if (d === h.EventBasedOn.VIEWPORT) { var A = w ? u / s : c / f; return A !== o.scrollPercent && n.dispatch((0, _.parameterChanged)(v, A)), { scrollPercent: A } }
                var S = K(i, v),
                ...
                return P !== o.scrollPercent && n.dispatch((0, _.parameterChanged)(S, P)), { scrollPercent: P }
            }
            ...
            if (!(r.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                ...
                if ("" !== l) {
                    ...
                    d.length && (e && (e.preventDefault(), e.stopPropagation()), function(t) {
                        ...
                        }(d, function() { E(d, "add"), d.focus(), E(d, "remove") })
                    }, e ? 0 : 300))
                }
            }
        }
    ...
    i.define("forms", t.exports = function(t, e) {
        ...
        function w(e) {
            ...
            }(n), T(e), o ? t.ajax({ url: u, type: "POST", data: r, dataType: "json", crossDomain: !0 }).done(function(t) { t && 200 === t.code && (e.success = !0), S(e) }).fail(function() { S(e) }) : S(e)
        }
    ...
    r.define("navbar", t.exports = function(t, e) {
        ...
        function A(n, r) {
            ...
            s && "/" === s.attr("href") && null == s.attr("aria-label") && s.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(E), a.button.off(E), a.menu.off(E), x(a), u ? (R(a), a.el.on("setting" + E, function(t) {
                return function(n, r) {
                    r = r || {};
                    var i = l.width();
                    x(t), !0 === r.open && G(t, !0), !1 === r.open && V(t, !0), t.open && e.defer(function() { i !== l.width() && C(t) })
                }
            }(a))) : (! function(e) {
                if (e.overlay) return;
        ...
        }, s.destroy = function() { O = t(), b(), a && a.length && a.each(S) };
        ...
        function G(t, e) {
            if (!t.open) {
                ...
                if (M(0, s), T.intro(0, s), r.redraw.up(), u || d.on("click" + E, t.outside), e) v();
                    ...
                    if (t.overlay && (O = t.menu.prev(), t.overlay.show().append(t.menu)), n.animOver) return f(t.menu).add(l).set({ x: n.animDirect * a, height: i }).start({ x: 0 }).then(v), void(t.overlay && t.overlay.width(a));
                    var p = c + o;
